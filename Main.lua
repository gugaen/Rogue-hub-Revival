...
local response = req({
    Url = "https://raw.githubusercontent.com/gugaen/Rogue-hub-Revival/main/Games/" .. game.PlaceId .. ".lua",
    Method = "GET"
})
...
if response.Body ~= "404: Not Found" then
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/gugaen/Rogue-hub-Revival/main/Games/" .. game.PlaceId .. ".lua", true))()
else
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Rogue Hub Error",
